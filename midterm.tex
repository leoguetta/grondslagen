...
\noindent\textbf{Exercise 1.} 
  ...
  \item (4 points) Let $L$ and $M$ be two well-ordered sets, prove that there
    exist an embedding $L \to M$ if and only if there exists a strictly
...
\noindent\textbf{Exercise 4.} Consider the language $L=\{f\}$, with $f$ a unary function symbol, and the $L$-structure $R$, whose
